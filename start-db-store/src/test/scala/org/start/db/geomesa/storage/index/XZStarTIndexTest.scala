...
import org.start.db.geomesa.storage.TestGeoMesaDataStore
...
class XZStarTIndexTest extends Specification with LazyLogging {

  "XZStarTIndex" should {
    "index and query daily epochs correctly" in {
      foreach(Seq("xzstart:geom:dtg")) { indices =>
        val spec =
