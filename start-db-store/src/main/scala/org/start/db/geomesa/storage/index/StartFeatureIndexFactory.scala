 ...
 */
package org.start.db.geomesa.storage.index

import org.start.db.geomesa.storage.index.xzstar.{XZStarIndex, XZStarTIndex}
import org.start.db.geomesa.storage.index.t1.T1Index
import org.start.db.geomesa.storage.index.z2t.{XZ2TIndex, Z2TIndex}
...
class StartFeatureIndexFactory extends GeoMesaFeatureIndexFactory {

  private val available = Seq(Z2TIndex, XZ2TIndex, XZStarIndex, T1Index, XZStarTIndex)
