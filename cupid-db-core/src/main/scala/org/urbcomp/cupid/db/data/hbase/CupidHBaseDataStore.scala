...
/**
  ...
  *
  *
  * CupidHbaseDataStore extend the original DataStore and provide a new #dropIndices
  * interface for drop index
  */
class CupidHBaseDataStore(con: ConnectionWrapper, config: HBaseDataStoreConfig)
