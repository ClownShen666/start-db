...
class LoadTest extends AbstractCalciteSparkFunctionTest {
  ...
  val PATH
      : String = CitibikeDataUtils.getProjectRoot + "/start-db-test/start-db-test-geomesa-geotools/src/main/resources/" + "202204-citibike-tripdata_clip_slice.csv"
  val PATH_OF_TRA
      : String = CitibikeDataUtils.getProjectRoot + "/start-db-test/start-db-test-geomesa-geotools/src/main/resources/" + "202204-citibike-tripdata_with_tra_road.csv"
  val PATH_OF_DATA_FOR_SPARK
      : String = CitibikeDataUtils.getProjectRoot + "/start-db-test/start-db-test-geomesa-geotools/src/main/resources/" + "202204-citibike-tripdata_with_tra_road_for_spark.csv"
