...
public interface StartDBSqlVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#createTableLikeStmt}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitCreateTableLikeStmt(StartDBSqlParser.CreateTableLikeStmtContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#showIndexStmt}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitShowIndexStmt(StartDBSqlParser.ShowIndexStmtContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#key_list}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitKey_list(StartDBSqlParser.Key_listContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#index_type_decl}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitIndex_type_decl(StartDBSqlParser.Index_type_declContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#dropIndexStmt}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitDropIndexStmt(StartDBSqlParser.DropIndexStmtContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#loadStmt}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLoadStmt(StartDBSqlParser.LoadStmtContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#load_mapping_columns}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLoad_mapping_columns(StartDBSqlParser.Load_mapping_columnsContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#load_mapping_items}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLoad_mapping_items(StartDBSqlParser.Load_mapping_itemsContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#load_mapping_item}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLoad_mapping_item(StartDBSqlParser.Load_mapping_itemContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#csv_file_options}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitCsv_file_options(StartDBSqlParser.Csv_file_optionsContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#csv_file_format}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitCsv_file_format(StartDBSqlParser.Csv_file_formatContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#renameTableStmt}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitRenameTableStmt(StartDBSqlParser.RenameTableStmtContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#old_name}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitOld_name(StartDBSqlParser.Old_nameContext ctx);

    /**
     * Visit a parse tree produced by {@link StartDBSqlParser#new_name}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitNew_name(StartDBSqlParser.New_nameContext ctx);
