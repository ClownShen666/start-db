...
import org.urbcomp.start.db.flink.FlinkQueryExecutor;
import org.urbcomp.start.db.util.FlinkSqlParam;
import org.urbcomp.start.db.flink.visitor.InsertIntoTableVisitor;
...
import static org.urbcomp.start.db.flink.FlinkQueryExecutor.sqlNodeCache;
        ...
        if (sql != null) {
            ...
            if (sqlNode.getKind().belongsTo(SqlKind.DDL)) {
                ...
                if (sqlNode instanceof SqlCreateDatabase
                    || sqlNode instanceof SqlStartCreateTable
                    ...
                    || sqlNode instanceof SqlStartCreateTableLike) {
