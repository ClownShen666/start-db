...
public final class RemoteServiceGrpc {
    ...
    public static final String SERVICE_NAME = "org.urbcomp.start.db.spark.data.RemoteService";

    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<
        org.urbcomp.start.db.spark.data.GrpcRemote.SchemaRequest,
        org.urbcomp.start.db.spark.data.GrpcRemote.SchemaResponse> getSendSchemaMethod;

    @io.grpc.stub.annotations.RpcMethod(
        fullMethodName = SERVICE_NAME + '/' + "sendSchema",
        requestType = org.urbcomp.start.db.spark.data.GrpcRemote.SchemaRequest.class,
        responseType = org.urbcomp.start.db.spark.data.GrpcRemote.SchemaResponse.class,
                        ...
                        io.grpc.MethodDescriptor.<
                            ...
                            .setFullMethodName(
                                generateFullMethodName(
                                    "org.urbcomp.start.db.spark.data.RemoteService",
                                    "sendSchema"
                                )
                            )
    ...
    private static volatile io.grpc.MethodDescriptor<
        ...
        org.urbcomp.start.db.spark.data.GrpcRemote.RowResponse> getSendRowMethod;

    @io.grpc.stub.annotations.RpcMethod(
        fullMethodName = SERVICE_NAME + '/' + "sendRow",
        requestType = org.urbcomp.start.db.spark.data.GrpcRemote.RowRequest.class,
        responseType = org.urbcomp.start.db.spark.data.GrpcRemote.RowResponse.class,
            ...
            synchronized (RemoteServiceGrpc.class) {
                if ((getSendRowMethod = RemoteServiceGrpc.getSendRowMethod) == null) {
                    RemoteServiceGrpc.getSendRowMethod = getSendRowMethod =
                        io.grpc.MethodDescriptor.<
                            org.urbcomp.start.db.spark.data.GrpcRemote.RowRequest,
                            org.urbcomp.start.db.spark.data.GrpcRemote.RowResponse>newBuilder()
    ...
    public static abstract class RemoteServiceImplBase implements io.grpc.BindableService {
        ...
        public void sendSchema(
            org.urbcomp.start.db.spark.data.GrpcRemote.SchemaRequest request,
            io.grpc.stub.StreamObserver<
                org.urbcomp.start.db.spark.data.GrpcRemote.SchemaResponse> responseObserver
        ) {
         ...
         */
        public
            io.grpc.stub.StreamObserver<org.urbcomp.start.db.spark.data.GrpcRemote.RowRequest>
            sendRow(
                io.grpc.stub.StreamObserver<
                    org.urbcomp.start.db.spark.data.GrpcRemote.RowResponse> responseObserver
            ) {
    ...
    public static final class RemoteServiceBlockingStub extends io.grpc.stub.AbstractStub<
        ...
        /**
         */
        public org.urbcomp.start.db.spark.data.GrpcRemote.SchemaResponse sendSchema(
            org.urbcomp.start.db.spark.data.GrpcRemote.SchemaRequest request
        ) {
    ...
    public static final class RemoteServiceFutureStub extends io.grpc.stub.AbstractStub<
        ...
        public
            com.google.common.util.concurrent.ListenableFuture<
                org.urbcomp.start.db.spark.data.GrpcRemote.SchemaResponse>
            sendSchema(org.urbcomp.start.db.spark.data.GrpcRemote.SchemaRequest request) {
    ...
    private static abstract class RemoteServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return org.urbcomp.start.db.spark.data.GrpcRemote.getDescriptor();
        }
