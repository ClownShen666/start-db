...
class st_traj_lengthInKMUdf extends ScalarFunction with AbstractUdf {

  override def name(): String = "st_traj_lengthInKM"
  ...
  def udfWrapper1: Trajectory => java.lang.Double = eval
}
